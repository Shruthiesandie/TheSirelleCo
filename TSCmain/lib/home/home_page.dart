    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // ✉️ LETTER CUSTOMIZATION – SKETCH EXACT LAYOUT
          _ScrollFadeIn(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    // 🧱 RIGHT STACKED FRAMES (3)
                    Positioned(
                      right: -10,
                      child: Column(
                        children: [
                          _sideFrame("assets/letters/letter_1.png"),
                          const SizedBox(height: 18),
                          _sideFrame("assets/letters/letter_2.png"),
                          const SizedBox(height: 18),
                          _sideFrame("assets/letters/letter_3.png"),
                        ],
                      ),
                    ),

                    // ✉️ CENTER MAIN LETTER (SKETCH ACCURATE)
                    Container(
                      width: 260,
                      height: 340,
                      decoration: BoxDecoration(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: const Color(0xFFB2004D).withOpacity(0.35),
                                    width: 1.2,
                                  ),
                                ),
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(20),
                                  child: Image.asset(
                                    "assets/letters/letter_sample.png",
                                    fit: BoxFit.contain,
